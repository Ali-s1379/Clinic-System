...
{
    public partial class AllDoctorForm : Form
    {
        public AllDoctorForm()
        {
            InitializeComponent();
        }

        private void AllDoctorForm_Load(object sender, EventArgs e)
        {
            try
            {
                SqlConnection cnn;
                ...
                SqlDataAdapter adp = new SqlDataAdapter("SELECT * FROM doctor", cnn);
